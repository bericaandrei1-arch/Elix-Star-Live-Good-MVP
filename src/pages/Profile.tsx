    ...
    <div className="min-h-screen bg-black text-white pb-24 pt-4 flex justify-center">
      <div className="w-full max-w-[500px]">
        ...
        <div className="border-b border-gray-800 flex justify-around text-gray-500">
            <button type="button" className="pb-2 border-b-2 border-white text-white w-1/3 flex justify-center" aria-label="Videos tab" title="Videos tab">
                <Play size={20} fill="currentColor" />
            </button>
            <button type="button" className="pb-2 border-b-2 border-transparent w-1/3 flex justify-center" aria-label="Private tab" title="Private tab">
                <Lock size={20} fill="currentColor" />
            </button>
            <button type="button" className="pb-2 border-b-2 border-transparent w-1/3 flex justify-center" aria-label="Likes tab" title="Likes tab">
